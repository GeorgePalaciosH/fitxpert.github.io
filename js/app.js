...
function Español() {
    ...
    document.getElementById("c1").textContent = 'Máquinas';
    document.getElementById("c2").textContent = 'Rutinas';
    document.getElementById("c3").textContent = 'Plan de Nutrición';
...
function Ingles() {
    ...
    document.getElementById("c1").textContent = 'Machines';
    document.getElementById("c2").textContent = 'Routines';
    document.getElementById("c3").textContent = 'Nutrition Plan';
...
function Portugues() {
    ...
    document.getElementById("c1").textContent = 'Máquinas';
    document.getElementById("c2").textContent = 'Rotinas';
    document.getElementById("c3").textContent = 'Plano de nutrição';
...
function Frances() {
    ...
    document.getElementById("c1").textContent = 'Machines';
    document.getElementById("c2").textContent = 'Routines';
    document.getElementById("c3").textContent = 'Plan nutritionnel';
